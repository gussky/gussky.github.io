...
useEffect(() => {
  ...
  >
    ...
    >
      ...
      {/* explicit line break between paragraphs */}
      <p>
        ...
        >
          <div style={{ display: "flex", gap: "20px" }}>
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ marginTop: "8px", paddingTop: "8px", borderTop: "1px solid #eee", lineHeight: "1.6" }}>
                <div>Nutri-Score: <strong>{hoveredPoint.nutriscore_grade?.toUpperCase() || "N/A"}</strong></div>
                ...
                <div>Energy: <strong>{hoveredPoint["energy-kcal_100g"].toFixed(0)} kcal</strong>/100g</div>
