...
export default function D3Radar() {
    ...
    const [data, setData] = useState<number[]>(new Array(FEATURES.length).fill(5));
    ...
    const handleInteraction = (e: React.MouseEvent | React.TouchEvent) => {
        ...
        const index = Math.round(angle / ( (2 * Math.PI) / FEATURES.length )) % FEATURES.length;
    ...
    return (
        <div className="flex flex-col md:flex-row items-center w-full min-h-[600px] bg-white p-8">
            ...
            <div className="w-full md:w-1/2 p-4">
                <h2 className="text-3xl font-bold text-gray-800 mb-4">Define "Healthy"</h2>
                <p className="text-gray-600 mb-6">
                    Using <span className="font-mono text-blue-600 bg-blue-50 px-1 rounded">D3.js</span> scales and shape generators.
                    <br/>
